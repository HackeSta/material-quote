...
facebook_caption = ""
twitter_caption = ""
instagram_caption = "Follow @materialquote for more such quotes \n"
...
twitter.upload_status(twitter_caption + twitter_tags,open(os.path.join(dir,'image.jpg'),'rb'))
facebook.upload_status(facebook_caption,os.path.join(dir,'image.jpg'))
instagram.upload_image(instagram_caption + instagram_tags,os.path.join(dir,'image.jpg'))
